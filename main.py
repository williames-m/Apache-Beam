...
def arredonda(elemento):
    """ 
    Recebe uma tupla ('RO-2019-02', 1470.4000000000026)
    Retorna uma tupla com o valor arredondado ('RO-2019-02', 1470.4)
    """
    chave, mm = elemento
...
chuvas = (
    ...
    | "Soma total das chuvas pela chave" >> beam.CombinePerKey(sum)
